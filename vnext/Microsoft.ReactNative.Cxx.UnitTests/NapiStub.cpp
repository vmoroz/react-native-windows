...
NAPI_EXTERN napi_status napi_define_properties(
    napi_env env,
    napi_value object,
...
NAPI_EXTERN napi_status napi_call_function(
    napi_env env,
    napi_value recv,
    napi_value func,
    size_t argc,
...
NAPI_EXTERN napi_status napi_define_class(
    napi_env env,
    const char *utf8name,
    size_t length,
...
NAPI_EXTERN napi_status napi_wrap(
    napi_env env,
...
NAPI_EXTERN napi_status napi_create_external_arraybuffer(
    napi_env env,
    void *external_data,
    size_t byte_length,
    napi_finalize finalize_cb,
...
NAPI_EXTERN napi_status napi_create_typedarray(
    napi_env env,
...
NAPI_EXTERN napi_status napi_get_typedarray_info(
    napi_env env,
...
NAPI_EXTERN napi_status napi_get_dataview_info(
    napi_env env,
    napi_value dataview,
    size_t *bytelength,
    void **data,
...
NAPI_EXTERN napi_status napi_add_finalizer(
    napi_env env,
    napi_value js_object,
    void *native_object,
    napi_finalize finalize_cb,
