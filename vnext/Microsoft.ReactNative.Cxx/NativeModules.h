...
//    if (auto m = static_cast<ModuleType *>(module)) {
//      CurrentNativeModuleBuilder::Get()->AddConstantProvider([ m, name = std::string(jsName), field ](
//          const IJSValueWriter &argWriter) mutable noexcept { WriteProperty(argWriter, name, m->*field); });
//    }
//    return false;
//  }
//};
...
//              const IJSValueWriter &argWriter) mutable noexcept { WriteProperty(argWriter, name, value); });
//    }
//
//    return false;
//  }
