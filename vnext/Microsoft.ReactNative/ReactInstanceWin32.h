...
#include "ReactNativeHost/React_win.h"

namespace Mso {
namespace React {

static_assert(static_cast<int32_t>(facebook::react::RCTLogLevel::Trace) == static_cast<int32_t>(LogLevel::Trace), "LogLevel::Trace value must match");
static_assert(static_cast<int32_t>(facebook::react::RCTLogLevel::Info) == static_cast<int32_t>(LogLevel::Info), "LogLevel::Info value must match");
static_assert(static_cast<int32_t>(facebook::react::RCTLogLevel::Warning) == static_cast<int32_t>(LogLevel::Warning), "LogLevel::Warning value must match");
static_assert(static_cast<int32_t>(facebook::react::RCTLogLevel::Error) == static_cast<int32_t>(LogLevel::Error), "LogLevel::Error value must match");
static_assert(static_cast<int32_t>(facebook::react::RCTLogLevel::Fatal) == static_cast<int32_t>(LogLevel::Fatal), "LogLevel::Fatal value must match");

//! ReactInstance implementation for Win32 that is managed by ReactHost.
class ReactInstanceWin32 final
	: public Mso::ActiveObject<IReactInstanceInternal, IReactInstanceWin32, Mso::JSHost::IFBReactInstance>
{
...
public:
	static void InitTracingAndTelemetry() noexcept;
...
private:
	...
	void RegisterRekaCxxModuleProvider(CxxModuleProviders& cxxModuleProviders) noexcept;
	...
	std::shared_ptr<facebook::react::MemoryTracker> GetMemoryTracker() noexcept;
...
private: // fields controlled by mutex
	...
	const Mso::ActiveReadableField<Mso::TCntPtr<Mso::Async::IDispatchQueue>> m_jsDispatchQueue { Queue(), m_mutex };

	const Mso::ActiveReadableField<std::shared_ptr<facebook::react::MessageQueueThread>> m_jsMessageThread { Queue(), m_mutex };
	const Mso::ActiveReadableField<std::shared_ptr<facebook::react::MessageQueueThread>> m_nativeMessageThread { Queue(), m_mutex };
	...
	const Mso::ActiveReadableField<Mso::TCntPtr<Mso::JSHost::IRekaInstance>> m_rekaInstance { Queue(), m_mutex };
};
