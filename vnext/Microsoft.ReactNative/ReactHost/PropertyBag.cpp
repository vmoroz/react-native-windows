...
Mso::CntPtr<IUnknown> ThreadSafePropertyBag::GetOrCreate(const void* isolationKey, const char* propertyName,
...
Mso::CntPtr<IUnknown> ThreadSafePropertyBag::Replace(const void* isolationKey, const char* propertyName,
...
Mso::CntPtr<IUnknown> WeakPropertyBagProxy::GetOrCreate(const void* isolationKey, const char* propertyName,
	const Mso::FunctorRef<Mso::CntPtr<IUnknown>()>& valueMaker) noexcept
{
...
Mso::CntPtr<IUnknown> WeakPropertyBagProxy::Replace(const void* isolationKey, const char* propertyName,
	Mso::CntPtr<IUnknown>&& value) noexcept
{
	if (auto propertyBag = m_weakPropertyBag.GetStrongPtr())
	{
...
Mso::CntPtr<IUnknown> PropertyBagLocalProxy::Replace(const void* isolationKey, const char* propertyName,
	Mso::CntPtr<IUnknown>&& value) noexcept
{
...
Mso::CntPtr<IUnknown> PropertyBagLocalProxy::GetOrCreate(const void* isolationKey, const char* propertyName,
	const Mso::FunctorRef<Mso::CntPtr<IUnknown>()>& valueMaker) noexcept
{
